...
@Component({
    ...
    <div class="page-header">
      <div class="page-title">
        ...
        <div>
          ...
          <p>{{ esEdicion() ? 'Actualiza la información del paciente'
      ...
      <div class="header-actions">
        @if (esEdicion()) {
          <a [routerLink]="['/pacientes', pacienteId()]">
            <p-button label="Ver Detalle" icon="pi pi-eye" [text]="true" severity="secondary" />
          </a>
        }
            ...
            <div class="form-grid">
              ...
              <div class="field required-field">
                ...
                <input pInputText formControlName="cedula"
                       ...
                       class="w-full" [readonly]="esEdicion()" />
                @if (isInvalid('cedula')) {
                  <small class="err">
                ...
                @if (esEdicion()) {
                  <small class="hint">
                    <i class="pi pi-lock"></i> La cédula no puede modificarse
                  </small>
                }
              </div>
              ...
              <div class="field">
                ...
                <input pInputText formControlName="historiaNúmero"
  ...
  styles: [`
    ...
    .form-card {
      ...
      padding: 0 0 1.5rem; box-shadow: 0 2px 12px rgba(0,0,0,0.07);
      overflow: hidden;
    }
    ...
    .section-subtitle .pi { color: #8b5cf6; }
...
export class PacienteFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (id) {
      ...
      this.form.get('cedula')?.disable();   // Cédula inmutable en edición
  ...
  onSubmit(): void {
    ...
    if (this.esEdicion()) {
      const { cedula, ...updatePayload } = payload;
  ...
  getError(field: string): string {
    ...
    if (ctrl?.hasError('pattern'))  return 'Debe ser exactamente 10 dígitos numéricos';
    return '';
  }
}